...
*/}}
{{- define "namespaceclass-controller.name" -}}
...
*/}}
{{- define "namespaceclass-controller.fullname" -}}
...
*/}}
{{- define "namespaceclass-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "namespaceclass-controller.resourceName" -}}
{{- $fullname := include "namespaceclass-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "namespaceclass-controller.serviceAccountName" -}}
{{- if .Values.serviceAccount.enabled }}
{{- include "namespaceclass-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- else }}
