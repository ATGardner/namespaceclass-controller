...
type NamespaceClassStatus struct {
	// failingNamespaces is the number of namespaces referencing this class
	// that failed to converge to its desired resources on their last
	// reconcile. Membership itself is discoverable on demand via
	// `kubectl get namespace -l namespaceclass.akuity.io/name=<name>`; this
	// field exists because failure isn't.
	// +optional
