...
KIND_CLUSTER ?= namespaceclass-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name namespaceclass-controller-builder
	$(CONTAINER_TOOL) buildx use namespaceclass-controller-builder
	...
	- $(CONTAINER_TOOL) buildx rm namespaceclass-controller-builder
	rm Dockerfile.cross
...
HELM_NAMESPACE ?= namespaceclass-controller-system
## Name of the Helm release
HELM_RELEASE ?= namespaceclass-controller
